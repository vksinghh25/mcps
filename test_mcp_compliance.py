...
class MCPComplianceTester:
    ...
    async def test_discovery_endpoint(self, agent_name: str, base_url: str) -> Dict[str, Any]:
    ...
    async def test_invoke_endpoint(self, agent_name: str, base_url: str, tool_name: str) -> Dict[str, Any]:
    ...
    async def test_health_endpoint(self, agent_name: str, base_url: str) -> Dict[str, Any]:
        ...
        for agent_name, base_url in self.agents.items():
            ...
            if discovery_result['status'] == "PASS" and discovery_result['data']:
                ...
                for tool in tools:
                    ...
                    invoke_result = await self.test_invoke_endpoint(agent_name, base_url, tool_name)
